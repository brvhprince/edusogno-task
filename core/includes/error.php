...
<div class="box">
    ...
    <div class="box__description">
        <div class="box__description-container">
            ...
            <div class="box__description-text">An error occurred connecting to database. If problem persists</div>
        </div>

        <a href="mailto:hello@edusogno.com" class="box__button">Contact us</a>
...
<script>
    const pageX=window.innerWidth,pageY=window.innerHeight;let mouseY=0,mouseX=0;document.addEventListener("mousemove",function(e){mouseY=e.pageY;const o=(pageY/2-mouseY)/pageY*300,n=100*-(mouseX=e.pageX/-pageX)-100;document.querySelector(".box__ghost-eyes").style.transform="translate("+n+"%,-"+o+"%)"});
</script>
</html>
